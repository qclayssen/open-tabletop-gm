...
| 6 | [Local DM with a smarter advisor](06-local-dm.md) | in review | |
| 6 | [Local DM with a smarter advisor](06-local-dm.md) | in review | [#8](https://github.com/qclayssen/open-tabletop-gm/pull/8) |
